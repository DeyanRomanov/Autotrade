...
from autotrade.userapp.views import RegisterUser, UserLogin, UserLogout, ProfileDetailsView, ProfileEditView, \
    ProfileUserDeleteView, ChangeUserPasswordView, ProfileCreateView, AutotradeUsersView, ForgottenUserPasswordView
...
urlpatterns = [
    ...
    path('forgotten_password/', ForgottenUserPasswordView.as_view(), name='forgotten password'),
